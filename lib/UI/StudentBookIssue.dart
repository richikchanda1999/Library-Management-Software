...
class StudentBookIssuePage extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Stack(children: <Widget>[
        ...
        MyStackWidget(
          ...
          child: Container(
            //margin: EdgeInsets.only(left: 30, right: 198, top: 690, bottom: 35),
            decoration: BoxDecoration(
        ...
        MyStackWidget(
          ...
          child: new Container(
            // margin: EdgeInsets.only(left: 198, right: 30, top: 690, bottom: 35),
            decoration: BoxDecoration(
              borderRadius: BorderRadius.all(Radius.circular(20.0)),
